...
状态：阶段 5 v2 Music live-compatible replacement 已完成并推送，Archive Studio v0 真实 v2 Music create 写入试点 preflight checker 已建立。
...
- [ ] 设计真实 v2 Music create smoke test 执行任务边界。
...
1. 设计真实 v2 Music create smoke test 执行任务边界；
