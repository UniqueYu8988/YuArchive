...
状态：阶段 5 v2 Music live-compatible replacement 已完成并推送，Archive Studio v0 transaction sandbox 已建立。
...
- [ ] 增加 Archive Studio v0 transaction sandbox 失败场景自检。
...
1. 增加 Archive Studio v0 transaction sandbox 失败场景自检；
