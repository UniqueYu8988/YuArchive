...
状态：阶段 5 v2 Music live-compatible replacement 已完成并推送，Archive Studio v0 真实 v2 写入 dry-run manifest 已建立。
...
- [ ] 增加真实 v2 Music 写入 dry-run manifest blocked 场景自检。
...
1. 增加真实 v2 Music 写入 dry-run manifest blocked 场景自检；
